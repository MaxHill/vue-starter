...
Files inside `static/` will be copied into this directory as-is during build. This means if you change this prefix, all your absolute URLs referencing files in `static/` will also need to be changed. See [Handling Static Assets](https://github.com/MaxHill/vue-starter/tree/master/docs/static.md) for more details.
...
Define proxy rules for the dev server. See [API Proxying During Development](https://github.com/MaxHill/vue-starter/tree/master/docs/proxy.md) for more details.
